...
namespace Linearstar.Keystone.IO.Metasequoia
{
    ...
    public class MqDocument
    {
        ...
        /// Scene
        /// </summary>
        public MqScene Scene { get; set; }

        /// <summary>
        /// Material
        /// </summary>
        public IList<MqMaterial> Materials { get; set; } = new List<MqMaterial>();

        /// <summary>
        /// Object
        /// </summary>
        public IList<MqObject> Objects { get; set; } = new List<MqObject>();

        public IList<MqChunk> CustomChunks { get; set; } = new List<MqChunk>();
