...
namespace Linearstar.Keystone.IO.Metasequoia
{
	...
	public class MqObject
	{
		...
		/// mirror_axis
		/// </summary>
		public MqMirrorAxis MirrorAxis
		{
			get;
			set;
		}
		...
		public MqObject()
		{
			this.Scale = new[] { 1f, 1, 1 };
			this.Rotation = new[] { 0f, 0, 0 };
			this.Translation = new[] { 0f, 0, 0 };
			this.Visible = true;
			this.Shading = MqShading.Gouraud;
			this.Color = new[] { 0.502f, 0.502f, 0.502f };
			this.Vertex = new List<float[]>();
			this.Weight = new Dictionary<int, float>();
			this.Faces = new List<MqFace>();
		}
